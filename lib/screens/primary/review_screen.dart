...
import 'package:ciaraos/widgets/review/execution_score_card.dart';
...
import 'package:ciaraos/widgets/review/review_metrics_grid.dart';
import 'package:ciaraos/widgets/review/review_screen_header.dart';
import 'package:ciaraos/widgets/review/system_reflection_card.dart';
...
class _ReviewScreenState extends ConsumerState<ReviewScreen> {
  ...
  Future<WeeklyReview> _buildReviewForExport() async {
    ...
    return WeeklyReview(
      ...
      startedRate: debrief.metrics.startedRate,
      totalTasks: debrief.metrics.tasksInScope,
      startedTasks: debrief.metrics.tasksStarted,
                  ...
                  child: ConstrainedBox(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        ReviewMetricsGrid(metrics: debrief.metrics),
                        const SizedBox(height: AppSpacing.reviewGap),
                        SystemReflectionCard(
                          bullets: debrief.reflectionBullets,
                          weekMonday: weekMonday,
                        ),
                        const SizedBox(height: AppSpacing.md),
                        Align(
